...
pub fn parse(path: &Path) -> Result<Vec<NseRecord>, String> {
    ...
    // ============================================================================
    // PASS 1: MAP ALL DATES FOR ALL CONTEXT BLOCKS DYNAMICALLY
    // ============================================================================
    ...
    loop {
        match reader.read_event_into(&mut buf) {
            ...
            Ok(Event::Text(e)) => {
                if !active_context_id.is_empty() && inside_period {
    ...
    // ============================================================================
    // PASS 2: STREAM EVERY FACT RECONCILED WITH ITS RELEVANT CONTEXT
    // ============================================================================
