    ...
    loop {
        match reader.read_event_into(&mut buf) {
            Ok(Event::Start(e)) => {
                ...
                // Strip structural namespace prefix from tag name
                ...
                // Look for the contextRef attribute directly in the element tags
            ...
            Ok(Event::Text(e)) => {
                if !open_tag.is_empty() && !open_context.is_empty() {
                    ...
                    // Format multi-line / split values into one clean, continuous string line
                    ...
                    if !clean_value.is_empty() {
                        // 🌟 Type-Fix: Instantiate NseRecord struct here
